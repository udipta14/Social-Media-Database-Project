-- 'users' table schema with insert command
CREATE TABLE users (
    ...
    created_at TIME(0) DEFAULT CAST(GETDATE() AS TIME(0))
);

INSERT INTO users(username, profile_photo_url, bio, email) VALUES 
('kanavphull', 'https://picsum.photos/90', 'Hedonist yet Spiritual || IT at NITJ 2024', 'as1mobiles@gmail.com'),
('raj gupta', 'https://picsum.photos/91', 'soon to be updated', 'admin@1shopbuy.com'),
('Sahib Singh', 'https://picsum.photos/92', 'Life is a journey, It drives you MAD.|| IT NITJ 24', '12angeldesignworld@gmail.com'),
('Sakshi Warandani', 'https://picsum.photos/93', 'NITJ wish me on 23 Jan', 'deepak@24sevenindia.com'),
('Omnicron Larson', 'https://picsum.photos/94', 'Heart Stealer', '101cartinfo@gmail.com'),
('dettol sharma', 'https://picsum.photos/95', 'Dettol Stealer', 'the.yellow.gold@gmail.com'),
('sunil', 'https://picsum.photos/96', 'hotel management', 'deepak@24sevenindia.com'),
('sanjay', 'https://picsum.photos/97', 'football lover', 'deepak@24sevenindia.com'),
('Axel Sivert Anker', 'https://picsum.photos/98', 'Norwegian', 'gazender.686@gmail.com'),
('Steven', 'https://picsum.photos/99', 'living life my way', 'sravi07@yahoo.com'),
('Jack', 'https://picsum.photos/100', 'Welcome to my Profile', 'contact@21fools.com'),
('Oliver', 'https://picsum.photos/101', 'Official Account', 'the.yellow.gold@gmail.com'),
('James', 'https://picsum.photos/102', 'Wish me on 3 Oct', 'contact@21fools.com'),
('Charlie', 'https://picsum.photos/103', 'aap yaha aaye kisliye', 'sravi07@yahoo.com'),
('Harris', 'https://picsum.photos/104', 'Sanskari Ladka', 'pawan.modi1@gmail.com'),
('Lewis', 'https://picsum.photos/105', 'aapne bulaya isliye', 'as1mobiles@gmail.com'),
('Leo', 'https://picsum.photos/106', 'Gym Lover', 'pawan.modi1@gmail.com'),
('Noah', 'https://picsum.photos/107', 'aae hain toh kaam bataiye', 'sunglasses.24@gmail.com'),
('Alfie', 'https://picsum.photos/108', 'Single', 'deepak@24sevenindia.com'),
('Rory', 'https://picsum.photos/109', 'phle zara aap muskurae', 'pawan.modi1@gmail.com'),
('Alexander', 'https://picsum.photos/110', 'Respect for all', 'umesh.agarwal@24x7safebuy.com'),
('Max', 'https://picsum.photos/111', 'Instagram King', 'as1mobiles@gmail.com'),
('Logan', 'https://picsum.photos/112', 'Cake Murder on 17 June', '101cartinfo@gmail.com'),
('Harry', 'https://picsum.photos/113', 'hhddsgb', 'shyamsunder121@gmail.com'),
('Theo', 'https://picsum.photos/114', 'Photography', 'info@3coinsplus.com'),
('Thomas', 'https://picsum.photos/115', 'siudgfibsiugs', 'wasif1@2dayenterprises.com'),
('Brodie', 'https://picsum.photos/116', 'Music Addict', 'shyamsunder121@gmail.com'),
('Archie', 'https://picsum.photos/117', 'uhiusgfufiusf', 'wasif1@2dayenterprises.com'),
('Jacob', 'https://picsum.photos/118', ' Single', 'mail@3gmobileworld.in'),
('Finlay', 'https://picsum.photos/119', 'usdsgbcu', 'mail@3gmobileworld.in'),
('Finn', 'https://picsum.photos/120', 'Proud to be Hindu', 'pawan.modi1@gmail.com'),
('Daniel', 'https://picsum.photos/121', 'hucussgcusn', 'shyamsunder121@gmail.com'),
('Joshua','https://picsum.photos/122','Big Fan of Mahakal','sunglasses.24@gmail.com'),
('Oscar','https://picsum.photos/123','Mr. Perfect','gazender.686@gmail.com'),
('Arthur','https://picsum.photos/124','Hate Me or Date Me','.'),
('Hunter','https://picsum.photos/125','photoholik','mail@3gmobileworld.in'),
('Ethan','https://picsum.photos/126','gygyuuy','deepak@24sevenindia.com'),
('Mason','https://picsum.photos/127',' foody ','sunglasses.24@gmail.com'),
('Harrison','https://picsum.photos/128','gfytfvy','contact@21fools.com'),
('Freddie','https://picsum.photos/129','single','contact@21fools.com'),
('Ollie','https://picsum.photos/130','fytfysguf','mail@3gmobileworld.in'),
('Adam','https://picsum.photos/131','U will find a boy better than me','sravi07@yahoo.com'),
('William','https://picsum.photos/132','fyasu','admin@1shopbuy.com'),
('Jaxon','https://picsum.photos/133','Official Account','info@3coinsplus.com'),
...
('George','https://picsum.photos/137','Music Lover','as1mobiles@gmail.com'),
('Jamie','https://picsum.photos/138','ygsgsogt','pawan.modi1@gmail.com'),
('Callum','https://picsum.photos/139','Sports Lover','mail@3gmobileworld.in')

select * from users

-- 'photos' table schema with insert command
CREATE TABLE photos (
...
-- 'videos' table schema with insert command
CREATE TABLE videos (
...
-- 'post' table schema with insert command
CREATE TABLE post (
...
-- 'comments' table schema with insert command
...
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE ('aag lga di h bss fire extinguisher bulana pdega',42,4);
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE ('ek kahani h jo sabko sunnani h jakne wako ki toh rooh bhi jaalani h',59,25);
...
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE ('You are a symbol of beauty.',77,38);
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE (' Surely you are the most beautiful woman alive, the most that I ve seen.',96,19);
...
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE ('You are the definition of Beauty',81,4);
...
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE ('You look mesmerizing.',68,22);
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE ('I wonder how cute you would be looking when you sleep.',6,35);
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE ('You are so much lovely.',29,47);
...
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE ('You are cute.',18,49);
...
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE ('You look even more pretty without makeup.',47,45);
...
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE ('You are stunning.',78,14);
...
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE ('. You look more beautiful than in the photo.',24,25);
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE (' You look stunning.',94,15);
...
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE ('Great shot!',82,29);
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE ('Nice shot!!',93,6);
...
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE ('Hot',3,7);
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUES ('?????? (three heart-eyed emojis)',44,7);
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE ('Wtf, how are you so pretty/handsome?',42,19);
...
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE ('A picture of their pet/pets:',26,20);
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE ('Soooooo cute!!',48,44);
...
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE ('Adorable kids, you got there!',76,20);
...
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE ('Sorry for your loss. My condolences go to you and your family.',26,37);
...
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE ('Congrats!',92,15);
...
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE ('Great shot!!',60,18);
...
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE ('Your eyes sparkle like something I''ve never seen before.',27,8);
...
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE ('NICE PLACE AND WATVH',41,47);
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE ('My words are less to describe this picture.',49,32);
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE ('FDSAFDS',22,1);
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE ('Beauty lies within for those who choose to see.',33,48);
INSERT INTO COMMENTS (comment_text ,post_id,user_id) VALUE ('BASDHIYAYY',3,18);
...
-- 'post_likes' table schema with insert command
...
INSERT INTO POST_LIKES(user_id,post_id) VALUE (8,54);
INSERT INTO POST_LIKES(user_id,post_id) VALUE (48,53);
INSERT INTO POST_LIKES(user_id,post_id) VALUE (15,62);
INSERT INTO POST_LIKES(user_id,post_id) VALUE (36,75);
INSERT INTO POST_LIKES(user_id,post_id) VALUE (5,62);
INSERT INTO POST_LIKES(user_id,post_id) VALUE (34,91);
INSERT INTO POST_LIKES(user_id,post_id) VALUE (36,44);
INSERT INTO POST_LIKES(user_id,post_id) VALUE (44,37);
...
INSERT INTO POST_LIKES(user_id,post_id) VALUE (35,5);
INSERT INTO POST_LIKES(user_id,post_id) VALUE (18,34);
INSERT INTO POST_LIKES(user_id,post_id) VALUE (35,48);
INSERT INTO POST_LIKES(user_id,post_id) VALUE (41,62);
INSERT INTO POST_LIKES(user_id,post_id) VALUE (3,59);
INSERT INTO POST_LIKES(user_id,post_id) VALUE (33,13);
INSERT INTO POST_LIKES(user_id,post_id) VALUE (37,3);
...
-- 'comment_likes' table schema with insert command
...
-- 'follows' table schema with insert command
...
-- 'hashtags' table schema with insert command
...
-- 'hashtags_follow' table schema with insert command
...
-- 'post_tags' table schema with insert command
...
-- 'bookmarks' table schema with insert command
...
-- 'login' table schema with insert command
CREATE TABLE login (
  login_id INTEGER NOT NULL IDENTITY(1,1) PRIMARY KEY,
  user_id INTEGER NOT NULL,
  ip VARCHAR(50) NOT NULL,
  login_time TIME(0) DEFAULT CAST(GETDATE() AS TIME(0)),
  FOREIGN KEY(user_id) REFERENCES users(user_id)
);
